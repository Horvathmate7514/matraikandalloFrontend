<template>
  <div class="gallery-container">
    <h1 class="pointerSelect d-flex justify-content-center" @click="selectType(1)">Kemence</h1>
    ...
    <h1 class="me-5 pointerSelect d-flex justify-content-center" @click="selectType(0)">Kandallo</h1>
    <div class="d-flex justify-content-center flex-wrap gap-3">
...
onMounted(() => {
  dataservice.getAllImages(0).then(data => {
    kandello.value = data.data;
  });
  dataservice.getAllImages(1).then(data => {
    Kemence.value = data.data;
  });
});
